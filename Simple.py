...
def loginSC():
	...
	if username =="Vais" and password =="fb":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Vaistv')
				menu()
